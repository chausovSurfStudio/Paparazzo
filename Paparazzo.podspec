Pod::Spec.new do |s|
  ...
  s.dependency 'ImageSource/Core', :git => 'https://github.com/chausovSurfStudio/ImageSource'
  s.dependency 'ImageSource/PHAsset', :git => 'https://github.com/chausovSurfStudio/ImageSource'
  s.dependency 'ImageSource/Local', :git => 'https://github.com/chausovSurfStudio/ImageSource'
  s.dependency 'ImageSource/Remote', :git => 'https://github.com/chausovSurfStudio/ImageSource'

  s.default_subspec = 'Core', 'Marshroute', 'AlamofireImage'

  s.subspec 'AlamofireImage' do |ai|
    ai.dependency 'Paparazzo/Core'
    ai.dependency 'ImageSource/AlamofireImage', :git => 'https://github.com/chausovSurfStudio/ImageSource'
  end

  s.subspec 'SDWebImage' do |sd|
    sd.dependency 'Paparazzo/Core'
    sd.dependency 'ImageSource/SDWebImage', :git => 'https://github.com/chausovSurfStudio/ImageSource'
  end
